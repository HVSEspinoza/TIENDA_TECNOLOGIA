...
if __name__ == "__main__":
    # Ejemplo para pruebas locales (usar rutas dinámicas desde la estructura)
    base_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'scraped_data')
    csv_file = os.path.join(base_dir, 'Lima - Principal_2025-03-15_12-00-00', 'Lima - Principal_2025-03-15_12-00-00.csv')
